...
class MotChallenge2DBox(_BaseDataset):
    ...
    def get_default_dataset_config():
        ...
        default_config = {
            ...
            # 'GT_FOLDER': "/media/v10016/实验室备份/XingshiXu/MyData/CowMulTrack_Datadata//test", # Location of GT data
            'TRACKERS_FOLDER': os.path.join(code_path, 'data/trackers/mot_challenge/'),  # Trackers location
            'OUTPUT_FOLDER': None,  # Where to save eval results (if None, same as TRACKERS_FOLDER)
            'TRACKERS_TO_EVAL': None,  # Filenames of trackers to eval (if None, all in folder)
            # 'CLASSES_TO_EVAL': ['pedestrian'],  # Valid: ['pedestrian']
            'CLASSES_TO_EVAL': ['Cow'],  # Valid: ['pedestrian']
            'BENCHMARK': 'f',  # Valid: 'MOT17', 'MOT16', 'MOT20', 'MOT15'
    ...
    def __init__(self, config=None):
        ...
        self.class_list = ['Cow']
        print("self.class_list is {}".format(self.class_list))
        if not all(self.class_list):
            raise TrackEvalException('Attempted to evaluate an invalid class. Only pedestrian class is valid.')
        self.class_name_to_class_id = {'Cow': 0, 'Cow11': 1, 'person_on_vehicle': 2, 'car': 3, 'bicycle': 4, 'motorbike': 5,
        ...
        print("tracker_list is {}".format(self.tracker_list))
        for tracker in self.tracker_list:
            if self.data_is_zipped:
                ...
                print("seq_list is {}".format(self.seq_list)) # seq_list 是十分重要的！
                for seq in self.seq_list:
                    print("+added+: {}*{}*{}*".format(self.tracker_fol, tracker, self.tracker_sub_fol))
    ...
    def _get_seq_info(self):
        ...
        # """
        # #
        # seq_list = ['20240425_3_01_D2', '20240425_3_01_D3']
        # seq_lengths = [1872,1872]
    ...
    def get_preprocessed_seq_data(self, raw_data, cls):
        ...
        for t in range(raw_data['num_timesteps']):
            ...
            if self.do_preproc and self.benchmark != 'MOT15' and gt_ids.shape[0] > 0 and tracker_ids.shape[0] > 0:
                ...
                print("gt_classes is:")
                print(np.unique(gt_classes))
                print("\n")
                print("valid_class_numbers is:")
